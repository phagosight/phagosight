function hPlotNet=plotTrackStats(handles,typeOfPlot,currentTrack,...
...
if typeOfPlot<5
    ...
    elseif (typeOfPlot<10) %Condition typeOfPlot>4 was unnecesary
                           %due the previous if, eliminated.
